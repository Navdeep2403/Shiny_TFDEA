  ...
  sidebarPanel(
    ...
    tabsetPanel(id="ts.setup",
                ...
                tabPanel("DEA Setup Model", value = "ts.setup.dea_selection",
                         selectInput('dea.inputs', 'Select Input(s):', 'NONE'),
                         selectInput('dea.outputs', 'Select Output(s):', 'NONE'),
...
#                       jqplotOutput("plot.result")
                ...
                tabPanel("Result MultiplierDEA", value="ts.result.mdea",
                         ...
                         h6("Free Weights"),
                         dataTableOutput('dt.mdea.Free_Weights'),
                         h6("Model Status"),
                         dataTableOutput('dt.mdea.Model_Status'),
                         h6("Input Values"),
                         dataTableOutput('dt.mdea.InputValues'),
                         h6("Output Values"),
                         dataTableOutput('dt.mdea.OutputValues'),
                         h6("HCU Input"),
                         dataTableOutput('dt.mdea.HCU_Input'),
                         h6("HCU Output"),
                         dataTableOutput('dt.mdea.HCU_Output'),
                         h6("vx"),
                         dataTableOutput('dt.mdea.vx'),
                         h6("uy"),
                         dataTableOutput('dt.mdea.uy')
                ),
